...
readr::write_excel_csv(df_ward_tax_offices,
  path = file.path(out_dirname, "yokohama_tax_office.csv")
)
readr::write_excel_csv(df_ward_tax_offices,
  path = file.path(out_dirname, "yokohama_tax_office.csv.gz")
)
```
...
- ブラウザから対話的に表示を変えたいなら、Shinyの使い方を学ぶ。「RとShinyで作るWebアプリケーション」を読んでから、[Mastering Shiny](https://mastering-shiny.org/)を読むとよいでしょう。
