...
```{r create_md, eval=TRUE, echo=FALSE}
command <- "Rscript -e"
command_args <- 'rmarkdown::render("r_in_30minutes.Rmd", rmarkdown::github_document(toc = TRUE, hard_line_breaks = TRUE, pandoc_args = c("--wrap=none")))'
system(paste(command, command_args))
```
