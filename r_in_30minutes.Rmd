...
```{python counter_class_python, result="asis"}
class Counter:
...
```{python call_by_reference_python, result="asis"}
...
```{r delete_command_args, eval=TRUE, echo=FALSE}
if (exists("g_args")) {
  rm(g_args)
}
```

```{r select_command_args}
